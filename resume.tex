...
\textsf{\textit{%
Team project used an FPGA development board to implement a flight controller module for a quadcopter in Verilog.
\setlist{nolistsep}
\begin{itemize}[noitemsep]
    \item Uses I2C to poll external sensor module
    \item Implemented a PID feedback controller to use sensor data to achieve stable flight
