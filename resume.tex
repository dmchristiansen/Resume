...
\begin{flushleft}
	...
	\textsf{\textit{%
			C, C++\\\vspace{1pt}
			Verilog/SystemVerilog\\\vspace{1pt}
			Python, Tensorflow\\\vspace{1pt}}}
...
\begin{flushleft}
	...
	\medskip
	%
	\textbf{Computer Architecture \& Microprocessor System Design\\}
	\textsf{\textit{Covered instruction pipelining and parallelization, branch prediction, memory systems, cache design, and bus operation\\}}\vspace{2pt}
	%
	%\textbf{Digital IC Design\\}
	%\textsf{\textit{Covered details of CMOS processes and transistor theory, as well as elements of VLSI design \& validation\\}}
	%
	...
	\textsf{\textit{Covered the basics of neural networks, SVMs, reinforcement learning, etc\\}}\vspace{2pt}
	%
	%\textbf{Solid State Physics\\}
	%\textsf{\textit{Survey of topics pertaining to semiconductor devices\\}}\vspace{2pt}
	%
\end{flushleft}
\end{minipage}
